...
public class KeyThree implements ObjInterface {

    private static KeyThree instance;
    ...
    private int x=8*16,y=11*16; // 8 11
    @Override
    ...
    public static KeyThree getInstance() {
        if (instance == null) {
            instance = new KeyThree();
        }
        return instance;
    }
    ...
    public void getImg() {
        try {
            tileset = ImageIO.read(new File("resources/Sprites/key-white.png"));
            int tileSize = 32;
    ...
    public void updateImg() {
        ...
        if (delay > 10) {
            spriteCounter++;
            spriteCounter = (spriteCounter % 12) + 1;
            delay = 0;
        }
    }
